...
const MatrixView = ({ tasks, onToggle, onDelete, onEdit }: MatrixViewProps) => {
    ...
    const quadrants = {
        q1: {
            ...
            subtitle: 'Do it now!',
            icon: Zap,
            color: 'bg-red-card  border-red-200 ',
        ...
        q2: {
            ...
            icon: Calendar,
            color: 'bg-blue-card  border-blue-200',
        ...
        q3: {
            ...
            icon: AlertCircle,
            color: 'bg-orange-card border-orange-200',
        ...
        q4: {
            ...
            subtitle: 'Delete it',
            icon: Coffee,
            color: 'bg-green-card border-green-200',
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm opacity-80 text-gray-400">{q.subtitle}</p>
                            </div>
                            <span className="ml-auto bg-card-bg px-3 py-1 rounded-full text-sm font-bold">
                                {q.tasks.length}
                            </span>
                        </div>
