  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        const formattedRoadmaps: RoadmapWithCount[] = (json.data || []).map(
          (r: any) => ({
            id: r.id,
            title: r.title,
    ...
    <div className="pt-25 px-10 max-w-7xl mx-auto">
      ...
      {currentRoadmap && (
        <div className="mt-12 text-center">
          <Link
            href="/dashboard"
            className="px-3 py-2 md:px-10 md:py-4 rounded-xl bg-primary text-[14px] md:text-lg md:font-semibold shadow-md hover:bg-primary-hover text-white"
          >
